    ...
    always_comb begin : reg_read_comb
        ...
        unique case (reg_raddr_i)
            ...
            begin
                ...
                reg_rdata_o[5:2] = status_grp.RX_LVL;
                reg_rdata_o[6] = status_grp.RX_BUSY;
                reg_rdata_o[7] = status_grp.TX_OVRN;
                reg_rdata_o[11:8] = status_grp.TX_LVL;
                reg_rdata_o[12] = status_grp.TX_BUSY;
            end
            `UART_RX_DATA_ADDR:
            begin
